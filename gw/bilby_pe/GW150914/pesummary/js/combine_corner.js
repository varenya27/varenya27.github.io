...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['IMRPhenomPv2'] = ['mass_ratio', 'chirp_mass', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'phi_12', 'phi_jl', 'dec', 'ra', 'theta_jn', 'psi', 'phase', 'luminosity_distance', 'geocent_time', 'log_likelihood', 'total_mass', 'mass_1', 'mass_2', 'symmetric_mass_ratio', 'chi_eff', 'chi_p', 'mass_1_source', 'mass_2_source', 'chirp_mass_source', 'total_mass_source', 'redshift'];
