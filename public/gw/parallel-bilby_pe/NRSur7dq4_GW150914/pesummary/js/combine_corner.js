...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['gwsignal4gwsurr'] = ['a_1', 'a_2', 'chi_eff', 'chi_p', 'chirp_mass', 'chirp_mass_source', 'dec', 'geocent_time', 'log_likelihood', 'luminosity_distance', 'mass_1', 'mass_1_source', 'mass_2', 'mass_2_source', 'mass_ratio', 'phase', 'phi_12', 'phi_jl', 'psi', 'ra', 'symmetric_mass_ratio', 'theta_jn', 'tilt_1', 'tilt_2', 'total_mass', 'total_mass_source', 'redshift'];
    ...
    var data = {}
    data['gwsignal4gwsurr'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
