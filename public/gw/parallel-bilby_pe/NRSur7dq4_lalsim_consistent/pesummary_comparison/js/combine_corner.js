...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['LALSim_NRSur7dq4'] = ['luminosity_distance', 'mass_ratio', 'chirp_mass', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'phi_12', 'phi_jl', 'theta_jn', 'psi', 'phase', 'geocent_time', 'log_likelihood', 'ra', 'dec', 'total_mass', 'mass_1', 'mass_2', 'symmetric_mass_ratio', 'chi_eff', 'chi_p', 'mass_1_source', 'mass_2_source', 'chirp_mass_source', 'total_mass_source', 'redshift'];
    list['Bilby:NRSur7dq4'] = ['luminosity_distance', 'mass_ratio', 'chirp_mass', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'phi_12', 'phi_jl', 'theta_jn', 'psi', 'phase', 'geocent_time', 'log_likelihood', 'ra', 'dec', 'total_mass', 'mass_1', 'mass_2', 'symmetric_mass_ratio', 'chi_eff', 'chi_p', 'mass_1_source', 'mass_2_source', 'chirp_mass_source', 'total_mass_source', 'redshift'];
    list['gwsignal_NRSur7dq4'] = ['luminosity_distance', 'mass_ratio', 'chirp_mass', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'phi_12', 'phi_jl', 'theta_jn', 'psi', 'phase', 'geocent_time', 'log_likelihood', 'ra', 'dec', 'total_mass', 'mass_1', 'mass_2', 'symmetric_mass_ratio', 'chi_eff', 'chi_p', 'mass_1_source', 'mass_2_source', 'chirp_mass_source', 'total_mass_source', 'redshift'];
    ...
    var data = {}
    data['LALSim_NRSur7dq4'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
    data['Bilby:NRSur7dq4'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
    data['gwsignal_NRSur7dq4'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
