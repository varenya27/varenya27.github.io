...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['NRHybSur3dq8'] = ['luminosity_distance', 'chirp_mass', 'mass_ratio', 'theta_jn', 'psi', 'phase', 'dec', 'ra', 'geocent_time', 'log_likelihood', 'total_mass', 'mass_1', 'mass_2', 'a_1', 'a_2', 'phi_jl', 'phi_12', 'tilt_1', 'tilt_2', 'symmetric_mass_ratio', 'chi_eff', 'chi_p', 'mass_1_source', 'mass_2_source', 'chirp_mass_source', 'total_mass_source', 'redshift'];
